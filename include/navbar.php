            ...
            <div class="container">
              <div class="d-flex align-items-center justify-content-between">
                <div class="col-md-9 offer">
                    <a href="" class="btn btn btn-sm">WECOME</a>
                </div>
                <div class="col-md-3 icons">

                    <a href="#" class="icons-btn d-inline-block "><span class="icon-person"><?php
/*
      ...
      <div class="container">
              ...
              <li class="has-children active">
                  ...
                  <ul class="dropdown">
                    ...
                    <li class="has-children">
                      <a href="#">Products</a>
                      <ul class="dropdown">
             <?php           $get_p_cats="SELECT * FROM p_categories" ;
       ...
       ?>
               ...
               <!--- <li><a href="#">Catalogue</a></li>
                ...
                <li><a href="customer/index.php?my_order">Account</a></li>
          ...
          <div class="icons">
            ...
            <a href="customer/index.php?my_fav" class="icons-btn d-inline-block"><span class="icon-heart-o"></span></a>
