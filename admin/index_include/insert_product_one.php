          ...
          <form action="#" method="POST" enctype="multipart/form-data">
              ...
              <div class="col-md-6">
                <label class="text-black h6">Product size</label>
                 <select id="c_country" class="form-control" name="size" required="">
...
if(isset($_POST['submit'])){
                  ...
                  if($s_img1 <= 1500000  ){
                        echo "size";
                         ...
                         /* $filenew2=uniqid('',true).".".$f_exta2;
                          $f_destination2='../admin/index_include/product/product_images/'.$filenew2;
                          move_uploaded_file($t_name2, $f_destination2);

                          $filenew3=uniqid('',true).".".$f_exta3;
                          $f_destination3='../admin/index_include/product/product_images/'.$filenew3;
         ...
         // $insert_p_query="INSERT INTO products(p_cat_id,cat_id,date,p_title,p_img1,p_img2,p_img3,size, p_price,p_keyword,p_description) VALUES('$p_cat','$cat',NOW(),'$p_title','$p_img1','$p_img2','$p_img3','$p_sizes','$p_price','$p_keyword','$p_desc')";
                 ...
                 //insert without size.
          $insert_p_query="INSERT INTO products(p_cat_id,cat_id,date,p_title,p_img1,p_price, p_keyword, p_description) VALUES ('$p_cat','$cat',NOW(),'$p_title','$filenew1','$p_price', '$p_keyword', '$p_desc')";
